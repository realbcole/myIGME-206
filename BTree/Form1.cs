...
namespace BTree
{
    public partial class Form1 : Form
    {
        ...
        private void Button6_Click(object sender, EventArgs e)
        {
            ...
            BTree node = null;
            BTree root = null;
            node = new BTree("START", root);
            root = node;
            node = new BTree("JURY", root);
            node = new BTree("MUSCLE", root);
            node = new BTree("CONTROL", root);
            node = new BTree("IVORY", root);
            node = new BTree("WHEEL", root);
            node = new BTree("PREDATOR", root);
            node = new BTree("BARRIER", root);
            node = new BTree("ANTICIPATION", root);
            node = new BTree("CROP", root);
            node = new BTree("CHALLENGE", root);
            node = new BTree("HARM", root);
            node = new BTree("STOMACH", root);
            node = new BTree("EX", root);
            node = new BTree("PERFORM", root);
            node = new BTree("DRILL", root);
